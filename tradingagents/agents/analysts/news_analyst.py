...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            "The identifier you receive may be a US ticker, an A-share stock code, or a company name. "
            "Treat numeric identifiers such as 600519 or 000547 as stock codes rather than literal company names. "
